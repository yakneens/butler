...
freebayes -f {{ pillar['reference_location'] }}  {{ pillar['pcawg_location_prefix'] }}/4d1fcef5-9c33-4852-963e-00dc2393eaf2/3bff6fb6d22946b29f935e60def05e65.bam  > /tmp/3bff6fb6d22946b29f935e60def05e65.vcf &
...
freebayes -f {{ pillar['reference_location'] }}  {{ pillar['pcawg_location_prefix'] }}/f00ee221-f51c-4fa9-bb62-8cb08a141bcd/e4bab214f06cb0664d4bb265fc3b9a1f.bam  > /tmp/e4bab214f06cb0664d4bb265fc3b9a1f.vcf &

freebayes -f {{ pillar['reference_location'] }}  {{ pillar['pcawg_location_prefix'] }}/b6cf3e41-3c1f-43df-adf0-b73ddbe92c45/27c6e06f744eb004af32433d957588a4.bam  > /tmp/27c6e06f744eb004af32433d957588a4.vcf &
