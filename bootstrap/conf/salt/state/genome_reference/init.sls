...
extract_reference:
  cmd.run:
    - name: gunzip -c /data/reference/genome.fa.gz > /data/reference/genome.fa    
    

/data/reference/genome.fa.gz.fai:
  file.managed:
...
/data/reference/genome.fa.fai:
  file.copy:
    - source: /data/reference/genome.fa.gz.fai
    - user: root
    - group: root
    - mode: 644
    
/data/reference/genome.fa.gz.64.amb:
  file.managed:
...
/data/reference/genome.fa.gz.64.ann:
  file.managed:
...
/data/reference/genome.fa.gz.64.bwt:
  file.managed:
...
/data/reference/genome.fa.gz.64.pac:
  file.managed:
...
/data/reference/genome.fa.gz.64.sa:
  file.managed:
