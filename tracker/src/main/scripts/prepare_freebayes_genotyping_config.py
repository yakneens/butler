...
if num_available_samples < num_runs:
    print "Only found " + str(num_available_samples) + " available samples to run. Will schedule " + str(num_available_samples) + " jobs."
...
for this_run in range(num_runs):
    ...
    this_config_data = {"donor_index": available_samples[this_run].index,
                        "sample_location": available_samples[this_run].normal_sample_location
                        }
