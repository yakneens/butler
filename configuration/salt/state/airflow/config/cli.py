...
def clear(args):
    ...
    dag.clear(
        ...
        only_upstream_failed=args.only_upstream_failed,
...
def get_parser():
    ...
    ht = "Only up_for_retry jobs"
    parser_clear.add_argument(
        "-u", "--only_retry", help=ht, action="store_true")
    ht = "Only upstream_failed jobs"
    parser_clear.add_argument(
        "-usf", "--only_upstream_failed", help=ht, action="store_true")
