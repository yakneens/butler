...
test_postgres_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(systemctl status postgresql-9.5 | grep running | wc -l) > 0 && /bin/true
...
test_rabbitmq_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(systemctl status rabbitmq-server | grep running | wc -l) > 0 && /bin/true
...
test_airflow_scheduler_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(systemctl status airflow-scheduler | grep running | wc -l) > 0 && /bin/true
...
test_airflow_webserver_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(systemctl status airflow-webserver | grep running | wc -l) > 0 && /bin/true
...
test_airflow_worker_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(systemctl status airflow-worker | grep running | wc -l) > 0 && /bin/true
...
test_influxdb_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(systemctl status influxdb | grep running | wc -l) > 0 && /bin/true
...
test_grafana_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(systemctl status grafana-server | grep running | wc -l) > 0 && /bin/true
...
test_chronograf_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(systemctl status chronograf | grep running | wc -l) > 0 && /bin/true
...
test_kapacitor_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(systemctl status kapacitor | grep running | wc -l) > 0 && /bin/true
...
test_telegraf_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(systemctl status telegraf | grep running | wc -l) > 0 && /bin/true