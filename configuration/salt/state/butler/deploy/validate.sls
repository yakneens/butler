...
test_airflow_scheduler_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(service airflow-scheduler status | grep running | wc -l) > 0 && /bin/true
...
test_airflow_webserver_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(service airflow-webserver status | grep running | wc -l) > 0 && /bin/true
...
test_airflow_worker_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(service airflow-worker status | grep running | wc -l) > 0 && /bin/true
...
test_influxdb_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(service influxdb status | grep running | wc -l) > 0 && /bin/true
...
test_grafana_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(service grafana-server status | grep running | wc -l) > 0 && /bin/true
...
test_chronograf_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(service chronograf status | grep running | wc -l) > 0 && /bin/true
...
test_kapacitor_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(service kapacitor status | grep running | wc -l) > 0 && /bin/true
...
test_telegraf_service:
  salt.function:
    ...
    - name: cmd.run
    - arg:
      - test $(service telegraf status | grep running | wc -l) > 0 && /bin/true